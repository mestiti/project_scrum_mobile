 ...
 * @author Asus
 */
public class Feature extends SideMenuBaseFormPO{
    ...
    Form current;
    public Feature(Resources res,String img,String username, int id){
 ...
 Feat fe = null;
        ...
        Servicefeat sb = new Servicefeat();
         ArrayList<Feat> bp = sb.getAllfeat(id);
          
        sp.setText(Servicefeat.getInstance().getAllfeat(id).toString());
     
      

        Toolbar tb = getToolbar();
        tb.setTitleCentered(false);
        TextField duration = new TextField("3000", "Duration", 6, TextArea.NUMERIC);
...
setTransitionOutAnimator(new FlipTransition(-1, duration.getAsInt(3000)));
              new Feature_formulaireajout(res,img,username,id).show();
        ...
        FontImage arrowDown = FontImage.createMaterial(FontImage.MATERIAL_KEYBOARD_ARROW_DOWN, "Label", 3);
         for (Feat obj : bp){
        addButtonBottom(res,arrowDown, obj.getIdf()+"                              "+obj.getFeature(), 0x5ae29d, true,obj,username,id,1,img);
        }
   ...
   private void addButtonBottom(Resources res,Image arrowDown, String text, int color, boolean first,Feat f,String username
...
setTransitionOutAnimator(new FlipTransition(-1, duration.getAsInt(2000)));
                ...
                new Feature_formulaire(res,img,username,idu,f).show();           
            }
        });
