 ...
 * @author Asus
 */
public class Feature_formulaireajout extends SideMenuBaseFormPO{
    ...
    public Feature_formulaireajout(Resources res,String img,String username, int id){
...
add(c);
        ...
        Button btadd=new Button("Add");
         ...
         s.ajouterfeat(s.getnum((String) c.getSelectedItem()).get(0), username.getText());
